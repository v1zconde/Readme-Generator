...
function renderLicenseBadge(license) {
  if (license === "MIT") license = "[![Github License: MIT](https://img.shields.io/badge/License-MIT-yellow)]";
  if (license === "APACHE 2.0") license = "[![Github License](https://img.shields.io/badge/License-Apache%202.0-blue)]";
  if (license === "GPL 3.0")license = "[![Github License: AGPL v3](https://img.shields.io/badge/License-AGPL%20v3-blue)]";
  if (license === "BSD 3")license = "[![Github License](https://img.shields.io/badge/License-BSD%203-blue)]";
...
function renderLicenseLink(license) {
  ...
  if (license === "GPL 3.0")license = "(https://www.gnu.org/licenses/agpl-3.0)";
